export const swedishVersion = {
    ...
    firstWebsite: {
        one: "Coworkify är en plattform som jag har skapat och som gör det möjligt för ägare av coworkinglokaler att publicera rum som användarbasen kan boka.",
        button: "Besök hemsidan"
    },
    secondWebsite: {
        one: "Eventfinders är ett projekt där jag började arbeta med frontend när jag gjorde praktik på Global Gurus under Karl Lillrud.",
        button: "Utforska frontend"
    },
    technologies: {
        one: "Mina tekniker",
