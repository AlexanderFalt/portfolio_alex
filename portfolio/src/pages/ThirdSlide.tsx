            ...
            {isMobile ? (
                <Box sx={{ 
                    ...
                    <Box sx={{height: "100%", width: "40%", padding: "2%"}}>
                        ...
                        <Button variant={'contained'} component="a" href="https://alexanderfalt.github.io/EventerFinders-MUI/" target="_blank" rel="noreferrer" sx={{
                            borderRadius: 2,
                            color: "#fff",
                ...
                <Box sx={{ 
                    ...
                    <Box sx={{ width: "100%", padding: "2%"}}>
                        <Typography sx={{opacity: 1, color: theme.palette.mode == "dark" ? "#fff" : "#000", fontWeight: "600", fontSize: "clamp(1.5rem, 10vw, 2rem)"}} variant="h3">EventFinders</Typography>
                        <Typography sx={{opacity: 1, color: theme.palette.mode == "dark" ? "#fff" : "#000", fontWeight: "400", fontSize: "clamp(0.8rem, 10vw, 1rem)", margin: "20px 5px"}} variant="body1">{langObject.secondWebsite.one}</Typography>                    
                        <Button variant={'contained'} component="a" href="https://alexanderfalt.github.io/EventerFinders-MUI/" target="_blank" rel="noreferrer" sx={{
                            borderRadius: 2,
                            color: "#fff",
                            background: theme.palette.secondary.main,
